...
先检查现有 Issue；大范围规则或来源调整建议先描述问题与证据。Fork 后建立独立分支，保持一次 PR 解决一个问题，在 PR 中列出实际检查结果与未验证项。维护者审查后合并，不要求贡献者发布版本。

讨论遵守[社区约定](CODE_OF_CONDUCT.md)，安全问题按[安全说明](SECURITY.md)私密报告。
